...
*/	{ MODKEY,                       XK_h,      setmfact,       {.f = -0.05} },
	...
	{ MODKEY,                       XK_F4,     spawn,          SHCMD("~/.bin/htop") },
	{ MODKEY,                       XK_F13,    spawn,          SHCMD("eject") },
	{ MODKEY,                       XK_F12,    spawn,          SHCMD("~/.bin/vol_up") },
	{ MODKEY,                       XK_F11,    spawn,          SHCMD("~/.bin/vol_down") },
	{ MODKEY,                       XK_F10,    spawn,          SHCMD("~/.bin/mute") },  
	{ MODKEY|ShiftMask,             XK_F12,    spawn,          SHCMD("~/.bin/shift_up") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
